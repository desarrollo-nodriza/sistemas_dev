<div class="page-title">
	<h2><span class="fa fa-shopping-bag"></span> Productos Tiendas</h2>
</div>

<div class="page-content-wrap">
	<div class="row">
		<div class="col-xs-12">
			<?= $this->Form->create('Filtro', array('url' => array('controller' => 'productotiendas', 'action' => 'index'), 'inputDefaults' => array('div' => false, 'label' => false))); ?>
					...
					<div class="table-responsive">
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td><span class="label label-success label-form"><?= h($producto['Productotienda']['reference']); ?>&nbsp;</span></td>
									<td><?= h($producto['pl']['name']); ?>&nbsp;</td>
									<td><?= CakeNumber::currency($producto['Productotienda']['price'], 'CLP'); ?>&nbsp;</td>
									<td><?= CakeNumber::currency($producto['Productotienda']['show_price'], 'CLP'); ?>&nbsp;</td>
									<td><?
